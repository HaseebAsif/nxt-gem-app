...
const Termsandconditions = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions | NXTGEM</title>
      </Head>
      <div className="bg-[url('https://res.cloudinary.com/nxtgem-io/image/upload/c_scale,w_680/v1640600879/background_app_klirup.png')] h-fit bg-no-repeat bg-cover py-20 text-white ">
        <img
          className="m-auto"
          src="https://res.cloudinary.com/nxtgem-io/image/upload/c_scale,w_930/v1642164728/Terms_and_Conditions_hndl8c.png"
          alt=""
        />
        <div className="w-4/5 md:w-3/5 m-auto">
          <p className="pb-6 text-md opacity-80">
            Last updated: December 01, 2021 <br />
          ...
          <h3 className="text-lg font-bold pb-6">Interpretation</h3>
          <p className="pb-6 text-md opacity-80">
          ...
          <h3 className="text-lg font-bold pb-6">Definitions</h3>
          <p className="pb-6 pl-12 text-md opacity-80">
          ...
          <p className="pb-6 pl-12 text-md opacity-80">
            ...
            this Agreement) refers to NXTGEM, Makati.
          </p>
          <p className="pb-6 pl-12 text-md opacity-80">
          ...
          <p className="pb-6 pl-12 text-md opacity-80">
            Website refers to NXTGEM, accessible from http://www.nxtgem.io
          </p>
          <p className="pb-6 pl-12 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Acknowledgment</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Links to Other Websites</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Termination</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Limitation of Liability</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Governing Law</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Disputes Resolution</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Severability and Waiver</h2>
          <h3 className="text-lg font-bold pb-6">Severability</h3>
          <p className="pb-6 text-md opacity-80">
          ...
          <h3 className="text-lg font-bold pb-6">Waiver</h3>
          ...
          <h2 className="text-xl font-bold pb-6">Translation Interpretation</h2>
          <p className="pb-6 text-md opacity-80">
          ...
          <h2 className="text-xl font-bold pb-6">Contact Us</h2>
          <p className="pb-6 text-md opacity-80">
            If you have any questions about these Terms and Conditions, You can
            contact us: By email: contact@nxtgem.io
          </p>
        </div>
      </div>
    </>
