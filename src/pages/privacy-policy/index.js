...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | NXTGEM</title>
      </Head>
      <div className="bg-[url('https://res.cloudinary.com/nxtgem-io/image/upload/c_scale,w_680/v1640600879/background_app_klirup.png')] h-fit bg-no-repeat bg-cover py-20 text-white ">
        ...
        <div className="w-4/5 md:w-3/5 m-auto">
          <p className="pb-6 text-md opacity-80">
            At <b> NXTGEM </b>, accessible from https://nxtgem.io, one of our
            main priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by NXTGEM and how we use it.
          </p>
          <p className="pb-6 text-md opacity-80">
          ...
          <p className="pb-6 text-md opacity-80">
            ...
            that they shared and/or collect in NXTGEM. This policy is not
          ...
          <p className="pb-6 text-md opacity-80">
            Like any other website, NXTGEM uses 'cookies'. These cookies are
          ...
          <p className="pb-6 text-md opacity-80">
            ...
            respective advertisements and links that appear on NXTGEM, which are
