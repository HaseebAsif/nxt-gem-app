    ...
    <div className="bg-[url('https://res.cloudinary.com/nxtgem-io/image/upload/c_scale,w_680/v1640600879/background_app_klirup.png')] h-fit bg-no-repeat bg-cover py-20 text-white ">
      ...
      <div className="w-4/5 md:w-3/5 m-auto">
        ...
        <p className="pb-6 text-md opacity-80">
          ...
          shared and/or collect in NXTGEM. This policy is not applicable to any
          information collected offline or via channels other than this website.
          Our Privacy Policy was created with the help of the Free Privacy
          Policy Generator.
        </p>
        <h2 className="text-xl font-bold pb-6">Consent</h2>
        <p className="pb-6 text-md opacity-80">
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <h2 className="text-xl font-bold pb-6">Information we collect</h2>
        <p className="pb-6 text-md opacity-80">
        ...
        <h2 className="text-xl font-bold pb-6">How we use your information</h2>
        <p className="pb-6 text-md opacity-80">
          We use the information we collect in various ways, including to:
        </p>
        <ul className="list-disc">
          <li className="pb-6 ml-16 text-md opacity-80 list-disc">
        ...
        <p className="pb-6 text-md opacity-80">
          NXTGEM follows a standard procedure of using log files. These files
        ...
        <h2 className="text-xl font-bold pb-6">Cookies and Web Beacons</h2>
        <p className="pb-6 text-md opacity-80">
          Like any other website, NXTGEM uses 'cookies'. These cookies are used
        ...
        <h2 className="text-xl font-bold pb-6">Our Advertising Partners</h2>
        <p className="pb-6 text-md opacity-80">
        ...
        <p className="pb-6 text-md opacity-80">
          ...
          advertising partners of NXTGEM.
        </p>
        <p className="pb-6 text-md opacity-80">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on NXTGEM, which are sent
        ...
        <p className="pb-6 text-md opacity-80">
          Note that NXTGEM has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>
        <h2 className="text-xl font-bold pb-6">Third Party Privacy Policies</h2>
        <p className="pb-6 text-md opacity-80">
          NXTGEM's Privacy Policy does not apply to other advertisers or
        ...
        <h2 className="text-xl font-bold pb-6">GDPR Data Protection Rights</h2>
        <p className="pb-6 text-md opacity-80">
        ...
        <h2 className="text-xl font-bold pb-6">Children's Information</h2>
        <p className="pb-6 text-md opacity-80">
        ...
        <p className="pb-6 text-md opacity-80">
          NXTGEM does not knowingly collect any Personal Identifiable
