...
const ExchangePageSmallCard = ({ Coins, Name }) => {
  let count = 1;

  return (
    <div className="h-[133px] mx-auto xl:mx-0 w-fit bg-[black]/80 text-white overflow-hidden">
      <div
      ...
      >
        <div
          className={`text-black font-semibold px-2 pt-1 ${styles.exchangeTitle}`}
        >
          {Name}
        </div>
      </div>
          ...
          <div className="flex text-sm py-1">
            ...
            <div className="opacity-90 flex items-end">
              {coin.market_cap_change_percentage_24h < 0 ? (
                <div className="text-red-400 pl-16 xl:pl-10">
                  {coin.market_cap_change_percentage_24h.toFixed(2)}%
                </div>
              ) : (
                <div className="text-green-400 pl-16 xl:pl-10">
                  {coin.market_cap_change_percentage_24h.toFixed(2)}%
                </div>
              )}
            </div>
