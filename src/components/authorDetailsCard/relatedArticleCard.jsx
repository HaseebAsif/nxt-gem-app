...
const RelatedArticleCard = () => {
  return (
    <div>
      <div class="container container max-w-xl m-auto flex flex-wrap flex-col md:flex-row items-center justify-start bg-[#023844]">
        <div class="w-full">
          <div class="flex flex-col xl:flex-row rounded overflow-hidden h-auto xl:h-36  shadow shadow-lg">
            <img
              class="block h-auto w-full xl:w-48 object-cover  flex-none bg-cover py-2 px-4"
